package winarwahyuw.winw.myloader;
        ...
        if(requestCode==CONTACT_REQUEST_CODE){
            if(granresults.length>0){
                if(granresults[0]== PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(this, "Contak Permission ditolak", Toast.LENGTH_SHORT).show();
                }
            }
            else if(requestCode==CALL_REQUEST_CODE){
                if(granresults[0]==PackageManager.PERMISSION_GRANTED){
                    Toast.makeText(this, "Call permisiion diterima", Toast.LENGTH_SHORT).show();
                }
                else{
